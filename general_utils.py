...
class PathHandler():
    def __init__(self):
        if sys.platform == 'linux':
            self.work_dir = Path('/media/data2/itzik/dev/ETFF')
            self.experiments = Path('/media/data2/itzik/dev/ETFF/experiments')
            ...
            self.baselines = Path('/media/data2/itzik/ETFF/baselines')
        else:
            self.work_dir = Path(r'K:\ETFF')
            self.experiments = Path(r'K:\ETFF\experiments')
            ...
            self.baselines = Path(r'K:\ETFF\baselines')
